...
module ProductSet = Set.Make (struct type t = int * int let compare = Stdlib.compare end);;
module IntListSet = Set.Make (struct type t = int list let compare = Stdlib.compare end);;
